...
describe('----------46 - Check clicking Print Button ---------', () => {
    try {
        ...
        it('46 - Check clicking Print Button ', function (done) {
            (async () => {
                console.log('Start checking clicking Print Button ')
                ...
                if (pageRows.length === 0) {
                    ...
                    if (pageNumber === '') {
                        ...
                        await pageRow.click()
                        const print = await driver.findElements(By.css('#preview .pdfHeader > .icon:first-child'))
                        await print.click()
                        done()
                    }
                }
