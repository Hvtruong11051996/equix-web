...
class SearchAccount extends React.Component {
    ...
    renderSuggest() {
        try {
            ...
            return listSearch.map((item, index) => {
                ...
                return <div style={{ borderTop: '1px solid var(--border)', paddingTop: '8px' }}>
                    <ItemSuggest
        ...
        try {
            ...
            if (node && node.offsetParent) {
                ...
                ReactDOM.render(this.renderSearchResultContent(), this.floatContent, () => {
                    ...
                    if (rect.top > spaceBottom && spaceBottom < 336) {
                        ...
                        if (this.floatContent.querySelector('.searchSuggestAccount')) {
                            this.floatContent.querySelector('.searchSuggestAccount').style.boxShadow = 'var(--shadow-top)';
                        }
                    } else {
                    ...
                    if (!this.props.rightAlign) {
                        ...
                        if (totalWidth > window.innerWidth) {
                            ...
                            else this.floatContent.style.left = rect.left + 'px';
                        }
                    } else {
    ...
    renderSearchResultContent() {
        return (
            <div className={`searchSuggest ${this.showSuggest()} searchSuggestAccount`}>
                <div>
