...
var ProgressBar = function () {
  ...
  _createClass(ProgressBar, [{
    ...
    value: function hide() {
      ...
      this.visible = false;
      this.bar.classList.add('myHidden');
    ...
    value: function show() {
      ...
      this.bar.classList.remove('myHidden');
    }
  }, {
    key: 'percent',
    get: function get() {
...
function webViewerInitialized() {
  ...
  if (!PDFViewerApplication.supportsPrinting) {
    appConfig.toolbar.print.classList.add('myHidden');
    appConfig.secondaryToolbar.printButton.classList.add('myHidden');
  }
  if (!PDFViewerApplication.supportsFullscreen) {
    appConfig.toolbar.presentationModeButton.classList.add('myHidden');
    appConfig.secondaryToolbar.presentationModeButton.classList.add('myHidden');
  }
  if (PDFViewerApplication.supportsIntegratedFind) {
    appConfig.toolbar.viewFind.classList.add('myHidden');
  }
  ...
  _createClass(OverlayManager, [{
    ...
    value: function open(name) {
      ...
      return new Promise(function (resolve) {
        ...
        _this3._active = name;
        _this3._overlays[_this3._active].element.classList.remove('myHidden');
        _this3._overlays[_this3._active].container.classList.remove('myHidden');
    ...
    value: function close(name) {
      ...
      return new Promise(function (resolve) {
        ...
        _this4._overlays[_this4._active].container.classList.add('myHidden');
        _this4._overlays[_this4._active].element.classList.add('myHidden');
        _this4._active = null;
...
var PDFFindBar = function () {
  ...
  _createClass(PDFFindBar, [{
    ...
    value: function updateResultsCount(matchCount) {
      ...
      if (!matchCount) {
        this.findResultsCount.classList.add('myHidden');
        this.findResultsCount.textContent = '';
      } else {
        this.findResultsCount.textContent = matchCount.toLocaleString();
        this.findResultsCount.classList.remove('myHidden');
      }
      this._adjustWidth();
    }
  }, {
    ...
    value: function switchView(view) {
      ...
      switch (view) {
        case SidebarView.THUMBS:
          ...
          this.thumbnailView.classList.remove('myHidden');
          this.outlineView.classList.add('myHidden');
          this.attachmentsView.classList.add('myHidden');
        ...
        case SidebarView.OUTLINE:
          ...
          this.attachmentsButton.classList.remove('toggled');
          this.thumbnailView.classList.add('myHidden');
          this.outlineView.classList.remove('myHidden');
          this.attachmentsView.classList.add('myHidden');
          break;
        case SidebarView.ATTACHMENTS:
          ...
          this.thumbnailView.classList.add('myHidden');
          this.outlineView.classList.add('myHidden');
          this.attachmentsView.classList.remove('myHidden');
          break;
        default:
...
var SecondaryToolbar = function () {
  ...
  _createClass(SecondaryToolbar, [{
    ...
    value: function open() {
      ...
      this._setMaxHeight();
      this.toggleButton.classList.add('toggled');
      this.toolbar.classList.remove('myHidden');
    }
  }, {
    key: 'close',
    value: function close() {
      ...
      this.opened = false;
      this.toolbar.classList.add('myHidden');
      this.toggleButton.classList.remove('toggled');
    }
  }, {
    key: 'toggle',
